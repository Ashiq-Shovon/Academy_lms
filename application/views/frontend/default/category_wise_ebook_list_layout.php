        ...
        <li>
            <div class="course-box-2">
                <div class="course-image">
                    ...
                    <a href="<?php echo $url = site_url('ebook/ebook_details/' . rawurlencode(slugify($ebook['title'])) . '/' . $ebook['ebook_id']) ?>">
                ...
                <div class="course-details">
                    ...
                    <div class="course-subtitle d-none d-md-block">
                        <?php echo ellipsis($ebook['description'], 60); ?>
                    </div>
                ...
                <div class="course-price-rating">
                    <div class="course-price">
                        ...
                        <?php else : ?>
                            <?php if ($ebook['discount_flag'] == 1) : ?>
                                <span class="current-price"><?php echo currency($ebook['discounted_price']); ?></span>
                                <span class="original-price"><?php echo currency($ebook['price']); ?></span>
                            <?php else : ?>
                                <span class="current-price"><?php echo currency($ebook['price']); ?></span>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
                    <div class="rating">
                        ...
                        $number_of_ratings = $this->crud_model->get_ratings( $ebook['ebook_id'])->num_rows();
                    ...
                    <div class="rating-number">
                        <?php echo $this->ebook_model->get_ratings( $ebook['ebook_id'])->num_rows() . ' ' . site_phrase('ratings'); ?>
                    </div>
                </div>
            </div>
        </li>
