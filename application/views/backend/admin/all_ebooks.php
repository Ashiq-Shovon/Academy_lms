        ...
        <div class="card">
            <div class="card-body py-2">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('ebooks'); ?>
                    <a href="<?php echo site_url('admin/add_blog'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo get_phrase('add_new_ebook'); ?></a>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
                        ...
                        <tbody>
                            ...
                            foreach ($ebooks as $key => $ebook) : ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo site_url('blog/details/'.slugify($ebook['title']).'/'.$ebook['ebook_id']); ?>" target="_blank"><?php echo $ebook['title']; ?></a><br>
                                    ...
                                    <td>
                                        <div class="dropright dropright">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="<?php echo site_url('ebook_manager/edit_ebook/' . $ebook['ebook_id']) ?>"><?php echo get_phrase('edit'); ?></a></li>
                                                <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('admin/blog/status/' . $ebook['ebook_id']); ?>');">
                                                	<?php if($ebook['is_active'] == 1){echo get_phrase('deactivate'); }else{ echo get_phrase('activate'); } ?>
                                                </a></li>
                                                <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('admin/blog/delete/' . $ebook['ebook_id']); ?>');"><?php echo get_phrase('delete'); ?></a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
